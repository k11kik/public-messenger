...
def spectral_matrix_from_spec2(times, freqs, spectrogram_x, spectrogram_y, spectrogram_z):
    """
...
def moving_average_time2(matrix, mov_ave=3):
    """
...
def moving_average_freq2(matrix, mov_ave=3):
    """
...
def svd_mag2(spectral_matrices, get_real_matrix=False):
    """
...
def polarization_from_specmtx2(
        spectral_matrices,
        quiet=False
):
    """
    ...
    dict_svd_result = svd_mag2(spectral_matrices, get_real_matrix=True)
...
def polarization_from_spec2(
    ...
    """
    spec_mtx = spectral_matrix_from_spec2(times, freqs, spec_x, spec_y, spec_z)

    # moving average
    spec_mtx = moving_average_time2(spec_mtx, mov_ave=mov_ave_time)
    spec_mtx = moving_average_freq2(spec_mtx, mov_ave=mov_ave_freq)
    wave_polarization = polarization_from_specmtx2(spec_mtx, quiet=quiet)
